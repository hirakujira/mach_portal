...
void init_iphone_7_plus_10_1_1_14b150() {
    printf("setting offsets for iPhone 7 / 7 Plus 10.1 ~ 10.1.1\n");
...
void init_offsets() {
    ...
    if (strstr(u.machine, "iPhone9,1") || strstr(u.machine, "iPhone9,2") || strstr(u.machine, "iPhone9,3") || strstr(u.machine, "iPhone9,4")) {
        // this is an iPhone 7 or 7 Plus
        
        if (strstr(u.version, "root:xnu-3789.22.3~1/RELEASE_ARM64_T8010")) {
            printf("this is a known kernel build for iPhone 7 / 7 Plus - offsets should be okay\n");
        } else {
            unknown_build();
        }
        init_iphone_7_plus_10_1_1_14b150();
        return;
    }
